...
#emotionColumns <- c("neutral","happy","sad","fear","anger","disgust","surprise","multi")
#emotionColumnsValence <- c("neutral","happy","sad","fear","anger","disgust","surprise","multi","valence")
